...
import com.eveningsamurai.symphony.model.LocationListResponse;
...
public class LocationListRequest extends Request{
	 ...
	 */
	public LocationListRequest(String apiKey, String sharedSecret) {
		super(apiKey, sharedSecret);
	}
	
	/** Endpoint for location list request api
	 * GET v3/locations
	 * @return location list url as string
	 */
	@Override
	public String getEndpoint() {
		return "https://api.conductor.com/v3/locations";
	}
	...
	protected Type getTypeForGson() {
		Type locationListResponseType = new TypeToken<LocationListResponse[]>() { }.getType();
		return locationListResponseType;
	}
