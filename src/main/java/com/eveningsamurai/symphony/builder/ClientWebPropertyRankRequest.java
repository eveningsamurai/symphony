...
import com.eveningsamurai.symphony.model.ClientWebPropertyRankResponse;
import com.google.gson.reflect.TypeToken;

public class ClientWebPropertyRankRequest extends Request {
	 ...
	 * Constructor
	 * 
	 * Create a new request builder for client web property rank report
	 ...
	 */
	public ClientWebPropertyRankRequest(String apiKey, String sharedSecret, String accountId, String webPropertyId, String rankSourceId, String timePeriodId) {
	 ...
	 * @return web property rank request url as string
	 */
	@Override
	public String getEndpoint() {
		return String.format("https://api.conductor.com/v3/%s/web-properties/%s/rank-sources/%s/tp/%s/serp-items", accountId, webPropertyId, rankSourceId, timePeriodId);
	}
	...
	protected Type getTypeForGson() {
		Type clientWebPropertyRankResponseType = new TypeToken<ClientWebPropertyRankResponse[]>() { }.getType();
		return clientWebPropertyRankResponseType;
	}
